...
<?php $__env->startSection('content'); ?>
    ...
    <div class="result_content">
        <div class="short_wrap">
            <a href="<?php echo e(url('admin/mof_work/category/create')); ?>" style="width: 120px;height: 45px;background: #eee;display: block;text-align: center;padding-top: 15px;font-size: 20px">添加图片</a>
        </div>
    </div>
            ...
            <table class="list_tab">
                ...
                <?php foreach($field as $v): ?>
                    <tr class="img_lst">
                        ...
                        <td class="tc"><?php echo e($v->cate_pid); ?></td>
                        ...
                        <td>
                            <a href="<?php echo e(url('admin/mof_work/category/'.$v->id.'/edit')); ?>">编辑</a>
    ...
    <script>
        ...
        function del(id) {
            layer.confirm('Are you sure?', {
                ...
                $.post("<?php echo e(url('admin/mof_work/category/')); ?>/"+id,{'_method':'delete','_token':"<?php echo e(csrf_token()); ?>"},function (data) {
                    if(data.status==0){
