...
@section('content')
    <div class="result_wrap">
        <form action="{{url('admin/mof_design/design/'.$field->id)}}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    <th>分类ID：</th>
                    <td>
                        <input type="text" class="sm" name="cate" value="{{$field->cate}}">
                    </td>
                </tr>
                <tr>
                    <th>描述：</th>
                    <td>
                        <input type="text" class="sm" name="describe" value="{{$field->describe}}">
                    </td>
                </tr>
                <tr>
                    <th>缩略图：</th>
