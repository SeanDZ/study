...
<div class="top_box">
	<div class="top_left">
		<div class="logo"><a href="{{'index'}}" style="cursor: pointer">莫夫后台管理</a></div>
	</div>
	<div class="top_right">
		<ul>
			<li>管理员：admin</li>
			...
			<ul>
				...
				<li>
					...
					<ul class="sub_menu">
                        ...
                        <ol style="display:none;cursor:pointer;width:200px" class="sub_ulli2">
                            <li><a href="{{url('admin/mof_work/work')}}" target="main"><i class="fa fa-fw fa-photo"></i>莫夫作品</a></li>
                            <li><a href="{{url('admin/mof_work/catename')}}" target="main"><i class="fa fa-fw fa-photo"></i>分类名称</a></li>
                            <li><a href="{{url('admin/mof_work/category')}}" target="main"><i class="fa fa-fw fa-th-large"></i>作品分类</a></li>
                        </ol>
                        ...
                        <ol style="display:none;cursor:pointer;width:200px" class="sub_ulli2">
                            <li><a href="{{url('admin/mof_tech/tech')}}" target="main"><i class="fa fa-fw fa-th-large"></i>莫夫技术图片</a></li>
                        </ol>
						...
						<ol style="display:none;cursor:pointer;width:200px" class="sub_ulli2">
							<li><a href="{{url('admin/mof_design/design')}}" target="main"><i class="fa fa-fw fa-th-large"></i>莫夫设计图片</a></li>
							<li><a href="{{url('admin/mof_design/des')}}" target="main"><i class="fa fa-fw fa-th-large"></i>相关产品图片</a></li>
						</ol>
				...
				<li>
					...
					<ul class="sub_menu">
						...
						<ol style="display:none;cursor:pointer;width:200px" class="sub_ulli2">
							<li><a href="{{url('admin/bcake/course')}}" target="main"><i class="fa fa-fw fa-photo"></i>首页轮播</a></li>
							<li><a href="{{url('admin/bcake/school')}}" target="main"><i class="fa fa-fw fa-th-large"></i>课程师资</a></li>
						</ol>
						...
						<ol style="display:none;cursor:pointer;width:200px" class="sub_ulli2">
							<li><a href="{{url('admin/bcake_major/major')}}" target="main"><i class="fa fa-fw fa-photo"></i>专业课程</a></li>
							<li><a href="{{url('admin/bcake_major/pro')}}" target="main"><i class="fa fa-fw fa-th-large"></i>课程轮播</a></li>
							<li><a href="{{url('admin/bcake_major/profession')}}" target="main"><i class="fa fa-fw fa-wrench"></i>课程介绍</a></li>
						</ol>
